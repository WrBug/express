package cn.mandroid.express.Model1.RongIMMessage1;
...
import cn.mandroid.express.UI1.activity.TaskDetailActivity_;
 ...
 */
@ProviderTag(messageContent = TaskInfoNoNoticeMessage.class, showPortrait = false, centerInHorizontal = true)
public class TaskInfoNoNoticeMessageItemProvider extends IContainerItemProvider.MessageProvider<TaskInfoNoNoticeMessage> {
    private Context context;

    @Override
    public void bindView(View view, int i, TaskInfoNoNoticeMessage taskInfoMessage, UIMessage uiMessage) {
    ...
    @Override
    public Spannable getContentSummary(TaskInfoNoNoticeMessage taskInfoMessage) {
        return new SpannableString(taskInfoMessage.getContent());
    }

    @Override
    public void onItemClick(View view, int i, TaskInfoNoNoticeMessage taskInfoMessage, UIMessage uiMessage) {
        Gson gson = new Gson();
        TaskInfoBean info = gson.fromJson(taskInfoMessage.getTaskInfo(), TaskInfoBean.class);
    ...
    @Override
    public void onItemLongClick(View view, int i, TaskInfoNoNoticeMessage taskInfoMessage, UIMessage uiMessage) {
